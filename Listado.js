...
app.get('/tareas/:id',function(req,res){
  var tareaEncontrada=null;
  listadoTareas.forEach(function(unElem){
if(unElem.id==req.params.id){
  tareaEncontrada=unElem;
}
});
res.render('tarea',{tarea:tareaEncontrada});
});
...
var tareaEncontrada = 
				listadoTareas.
				  find(function(unElem) {
					return unElem.id==req.params.id;
});
var tareaEncontrada = null;
listadoTareas.forEach(function(unElem) {
  if(unElem.id == req.params.id) {
